    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <textarea
          ...
          placeholder={mode === 'encode' ? 'Text to encode...' : 'URL encoded string to decode...'}
          value={input}
        ...
        <div className="relative">
          ...
          {output && (
            <button
              ...
              className="absolute top-2 right-2 rounded-md bg-[var(--color-surface)] border border-[var(--color-border)] px-2 py-1 text-xs font-medium text-[var(--color-text-secondary)] hover:bg-[var(--color-surface-hover)] transition-colors"
            >
              {copied ? 'Copied!' : 'Copy'}
            </button>
          )}
