...
const tools = [
  ...
  { slug: 'image-to-base64', titleZh: '图片转Base64', titleEn: 'Image to Base64', descZh: '将图片文件转换为Base64字符串', descEn: 'Convert image files to Base64 strings', category: 'utility', icon: 'Binary' },
